(function() {
    ...
    OeuvreDialogController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', 'entity', 'Oeuvre', 'Auteur'];

    function OeuvreDialogController ($timeout, $scope, $stateParams, $uibModalInstance, entity, Oeuvre, Auteur) {
        var vm = this;
